...
`git clone https://github.com/ohroy/r0yLLDB.git && cd r0yLLDB && ./install.sh`

#### It highly recommend you to install [fruity-frida](https://github.com/ChiChou/fruity-frida)
